...
namespace Doozy.Editor.Soundy
{
    ...
    public class SoundGroupDataEditor : BaseEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            m_previewAudioSource = EditorUtility.CreateGameObjectWithHideFlags("Soundy Audio StateData Preview", HideFlags.HideAndDontSave, typeof(AudioSource)).GetComponent<AudioSource>();
