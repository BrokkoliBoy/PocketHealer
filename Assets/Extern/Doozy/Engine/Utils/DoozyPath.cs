...
namespace Doozy.Engine.Utils
{
    ...
    public class DoozyPath : ScriptableObject
    {
        ...
        private const string DATA = "StateData";
        ...
        public static string ENGINE_RESOURCES_DATA_PATH = Path.Combine(ENGINE_RESOURCES_PATH, DATA);                   // -- Doozy/Engine/Resources/StateData/
        public static string ENGINE_RESOURCES_DATA_SOUNDY_PATH = Path.Combine(ENGINE_RESOURCES_DATA_PATH, SOUNDY);     // -- Doozy/Engine/Resources/StateData/Soundy/
        public static string ENGINE_RESOURCES_DATA_UIBUTTON_PATH = Path.Combine(ENGINE_RESOURCES_DATA_PATH, UIBUTTON); // -- Doozy/Engine/Resources/StateData/UIButton/
        public static string ENGINE_RESOURCES_DATA_UICANVAS_PATH = Path.Combine(ENGINE_RESOURCES_DATA_PATH, UICANVAS); // -- Doozy/Engine/Resources/StateData/UICanvas/
        public static string ENGINE_RESOURCES_DATA_UIDRAWER_PATH = Path.Combine(ENGINE_RESOURCES_DATA_PATH, UIDRAWER); // -- Doozy/Engine/Resources/StateData/UIDrawer/
        public static string ENGINE_RESOURCES_DATA_UIPOPUP_PATH = Path.Combine(ENGINE_RESOURCES_DATA_PATH, UIPOPUP);   // -- Doozy/Engine/Resources/StateData/UIPopup/
        public static string ENGINE_RESOURCES_DATA_UIVIEW_PATH = Path.Combine(ENGINE_RESOURCES_DATA_PATH, UIVIEW);     // -- Doozy/Engine/Resources/StateData/UIView/
        public static string ENGINE_RESOURCES_DATA_THEMES_PATH = Path.Combine(ENGINE_RESOURCES_DATA_PATH, THEMES);     // -- Doozy/Engine/Resources/StateData/Themes/
        ...
        /// <summary> Returns -- Doozy/Engine/Resources/StateData/{componentName}/ </summary>
...
//            DoozyUtils.ClearProgressBar();
            ...
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_PATH)) UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_PATH, DATA); // -- Doozy/Engine/Resources/StateData/

            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_RESOURCES_DATA_SOUNDY_PATH, 0.12f);
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_SOUNDY_PATH)) UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_DATA_PATH, SOUNDY); // -- Doozy/Engine/Resources/StateData/Soundy/

            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_RESOURCES_DATA_UIBUTTON_PATH, 0.13f);
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_UIBUTTON_PATH)) UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_DATA_PATH, UIBUTTON); // -- Doozy/Engine/Resources/StateData/UIButton/

            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_RESOURCES_DATA_UICANVAS_PATH, 0.14f);
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_UICANVAS_PATH)) UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_DATA_PATH, UICANVAS); // -- Doozy/Engine/Resources/StateData/UICanvas/

            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_RESOURCES_DATA_UIDRAWER_PATH, 0.15f);
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_UIDRAWER_PATH)) UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_DATA_PATH, UIDRAWER); // -- Doozy/Engine/Resources/StateData/UIDrawer/

            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_RESOURCES_DATA_UIPOPUP_PATH, 0.16f);
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_UIPOPUP_PATH)) UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_DATA_PATH, UIPOPUP); // -- Doozy/Engine/Resources/StateData/UIPopup/

            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_RESOURCES_DATA_UIVIEW_PATH, 0.17f);
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_UIVIEW_PATH)) UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_DATA_PATH, UIVIEW); // -- Doozy/Engine/Resources/StateData/UIView

            if (!silentMode) DoozyUtils.DisplayProgressBar("Validate Folder", ENGINE_RESOURCES_DATA_THEMES_PATH, 0.18f);
            if (!UnityEditor.AssetDatabase.IsValidFolder(ENGINE_RESOURCES_DATA_THEMES_PATH)) UnityEditor.AssetDatabase.CreateFolder(ENGINE_RESOURCES_DATA_PATH, THEMES); // -- Doozy/Engine/Resources/StateData/Themes
