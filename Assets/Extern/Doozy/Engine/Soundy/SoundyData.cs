...
{
    /// <summary>
    ///     StateData settings container used by the Actions class in order to trigger the playing of a sound via Soundy, a direct AudioClip reference or a MasterAudio sound name.
    /// </summary>
    [Serializable]
